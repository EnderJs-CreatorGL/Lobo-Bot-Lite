...
[`${conn.user.jid.split('@')[0]}`, `𝗘𝘀 𝗨𝗻 𝗕𝗼𝘁 🍁`, `${await conn.getName(conn.user.jid)}`, `📵 No Hacer Spam`, 'thelobobot@gmail.com', `🇳🇮 Nicaragua`, `https://github.com/EnderJs-CreatorGL/Lobo-Bot-Lite`, biobot],  [`${numero}`, `𝗢𝘄𝗻𝗲𝗿 𝗢𝗳𝗰 🗒️`, `${await conn.getName(conn.user.jid)}`, `🏷 Solo Cosas Importantes`, 'theyotsubanakano@gmail.com', `🇨🇴 Colombia`, `https://github.com/Diego-YL-177/`, bio]
], m)
