...
global.db.data.users[m.sender].spam = new Date * 1
     ...
     if (!opts['noprint']) await (await import(`./lib/print.js`)).default(m, this)
      ...
      // await conn.sendPresenceUpdate('', m.chat)

     if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|mente|pero|tion|age|ous|ate|and|but|ify|lobo|host|a|s)/gi)) {
...
const msg = {
rowner: '「🔰」 *Esta función solo puede ser usada por el staff del bot.*', 
owner: '「👑」 *Esta función solo puede ser usada por el staff del bot.*', 
mods: '「🤴🏻」 *Esta función solo puede ser usada por el staff del bot.*', 
premium: '「🍧」 *Esta función solo es para usuarios Premium.*', 
group: '「⚜️」 *Esta funcion solo puede ser ejecutada en grupos.*', 
private: '「⭐️」 *Esta función solo puede ser usada en chat privado.*', 
admin: '「🐢」 *Este comando solo puede ser usado por admins.*', 
botAdmin: '「🧊」 *Para usar esta función debo ser admin.*', 
unreg: '「💠」 *¡Hey! no estas registrado, registrese para usar esta función*\n\n*/reg nombre.edad*\n\n*_❕ Ejemplo_* : */reg Lobo.666*',
