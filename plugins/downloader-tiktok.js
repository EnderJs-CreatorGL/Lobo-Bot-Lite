...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'ʟᴏʙᴏ- ʙᴏᴛ', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/Ender-GB-Isis777/LOBO-BOT-MD'}, mentionedJid: [m.sender]}}}, aa);
