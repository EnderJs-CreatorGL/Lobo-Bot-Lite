      ...
      if (chat.welcome) {
        ...
        for (const user of participants) {
          ...
          try {
            ...
            this.sendMessage(id, { text: text, contextInfo:{ mentionedJid:[user], "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "title": '乂 ＷＥＬＣＯＭＥ 乂', "body": '${user.split('@')[0]}', "previewType": "PHOTO", "thumbnailUrl": ``, "thumbnail": apii.data, "sourceUrl": md}}})
          }
        }
      }
      break;
