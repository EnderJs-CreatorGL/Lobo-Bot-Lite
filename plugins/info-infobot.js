...
[🔮] *𝙰𝚄𝚃𝙾𝚁𝙴𝙰𝙳:* ${autoread ? "𝑶𝒏√" : "𝑶𝒇𝒇√"}
[⚖️] *𝚁𝙴𝚂𝚃𝚁𝙸𝙲𝚃:* ${restrict ? "𝑶𝒏√" : "*𝑶𝒇𝒇√"} 
[💬] *𝙿𝙲𝙾𝙽𝙻𝚈:* ${pconly ? "𝑶𝒏√" : "𝑶𝒇𝒇√"}
[🏢] *𝙶𝙲𝙾𝙽𝙻𝚈:* ${gconly ? "𝑶𝒏√" : "𝑶𝒇𝒇√"}
[🌐] *𝙼𝙾𝙳𝙾:* ${self ? "𝑷𝒓𝒊𝒗𝒂𝒕𝒆√" : "𝑷𝒖𝒃𝒍𝒊𝒄√"}
[💬] *𝙰𝙽𝚃𝙸𝙿𝚁𝙸𝚅𝙰𝙳𝙾:* ${antiprivado ? "𝑶𝒏√" : "𝑶𝒇𝒇√"}
[💻] *𝙼𝙾𝙳𝙴𝙹𝙸𝙱𝙾𝚃:* ${modejadibot ? "𝑶𝒏√" : "𝑶𝒇𝒇√"}
[📵] *𝙰𝙽𝚃𝙸𝙻𝙻𝙰𝙼𝙰𝙳𝙰:* ${antiCall ? "𝑶𝒏√" : "𝑶𝒇𝒇√"}
[⌚] *𝚅𝙴𝙻𝙾𝙲𝙸𝙳𝙰𝙳:* ${speed} ms
   〘 𝕷𝖔𝖇𝖔-𝕭𝖔𝖙-𝕸𝕯 〙 ═
`.trim();
  const doc = [
