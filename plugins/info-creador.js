...
let bioowner = bioowner.status?.toString() || 'Sin Biografía'
let bioowner = await conn.fetchStatus('573012482597' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
let biobot = biografiaBot.status?.toString() || 'Sin Biografía'
let name = await conn.getName(who)

  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `${await conn.getName('50558124470'+'@s.whatsapp.net')}`, `💖 Creador`, saludo, 'enderjosueasevedotorrez@gmail.com', `🇳🇮 Nicaragua`, `https://www.youtube.com/@EnderOwner`, bio], [`${owner}`, ${await conn.getName('573012482597'+'@s.whatsapp.net')}`, `🍧 Owner`, saludo, 'theyotsubanakano@gmail.com', `🇨🇴 Colombia`, `https://www.youtube.com/@Yotsuba.nakano01`, bioowner],
