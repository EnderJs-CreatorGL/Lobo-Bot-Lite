...
//lete botsito = 50558124470
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `${await conn.getName('50558124470'+'@s.whatsapp.net')}`, `💖 Creador`, saludo, 'argumedod44@gmail.com', `🇳🇮 Nicaragua`, `https://www.youtube.com/@EnderOwner`, bio],
[`${conn.user.jid.split('@')[0]}`, `𝗘𝘀 𝗨𝗻 𝗕𝗼𝘁 🍁`, `${await conn.getName(conn.user.jid)}`, `📵 No Hacer Spam`, 'thelobobot@gmail.com', `🇳🇮 Nicaragua`, `https://github.com/EnderJs-CreatorGL/Lobo-Bot-Lite`, biobot],  [`${numero}`, `𝗢𝘄𝗻𝗲𝗿 𝗢𝗳𝗰 🗒️`, `${await conn.getName('573012482597'+'@s.whatsapp.net')}`, `🏷 Solo Cosas Importantes`, 'theyotsubanakano@gmail.com', `🇨🇴 Colombia`, `https://github.com/Diego-YL-177`, `✨️ L'amore è una cosa meravigliosa 💖`]
], m)
