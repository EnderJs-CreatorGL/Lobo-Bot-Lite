const handler = async (m, { conn, command, text }) => {
  ...
  const response =
    `━━━━━━━⬣ ☆𝗟𝗢𝗩𝗘☆ ⬣━━━━━━━\n` +
    `*❥𝑺𝒆𝒈𝒖𝒏 𝒚𝒐 𝑳𝒐𝒃𝒐-𝑩𝒐𝒕-𝑳𝒊𝒕𝒆🐈🌻, ${text} y @${m.sender.split('@')[0]} ${loveDescription} del ${lovePercentage}% de un 100%*\n\n` +
    `*❥ ✦${loveMessage}*\n` +
    `━━━━━━━⬣ ☆𝗟𝗢𝗩𝗘☆ ⬣━━━━━━━`    
...
"《 ████████████》100%"
   ...
   let { key } = await conn.sendMessage(m.chat, {text: `💘¡𝗘𝗺𝗽𝗲𝘇𝗮𝗻𝗱𝗼 𝗲𝗹 𝗰𝗮𝗹𝗰𝘂𝗹𝗼 𝗱𝗲 𝗮𝗺𝗼𝗿!💘`, mentions: conn.parseMention(response)}, {quoted: m})
