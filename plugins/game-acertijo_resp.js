...
if (!db.data.chats[m.chat].game) throw `${lenguajeLB['smsAvisoAG']()}𝐽𝑢𝑒𝑔𝑜𝑠 𝐷𝑒𝑠𝑎𝑐𝑡𝑖𝑣𝑎𝑑𝑜𝑠 : #on juegos` 
...
const res = await fetchJson(`https://raw.githubusercontent.com/EnderJs-CreatorGL/Lobo-Bot-Lite/master/src/JSON/tebaklagu.json`);
