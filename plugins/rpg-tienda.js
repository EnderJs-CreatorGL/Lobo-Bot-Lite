...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: 'VIDEO', description: '',title: wm, body: 'Lobo-Bot-MD ', thumbnailUrl: await(await fetch(global.img)).buffer(), sourceUrl}}}
let dos = [enlace2]
